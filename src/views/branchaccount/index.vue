<template>
  <div class="mod-config">
    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <div class="btns">
        <div class="btns-right">
          ...
          <el-button v-if="isAuth('account:branchaccount:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
          <el-button v-if="isAuth('account:branchaccount:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
          <div class="clear"></div>
        </div>
      </div>
    </el-form>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="outAccountOffice" header-align="center" align="center" label="出账门店">
      </el-table-column>
      <el-table-column prop="inAccountOffice" header-align="center" align="center" label="入账门店">
      </el-table-column>
      <el-table-column prop="totalAmount" header-align="center" align="center" label="总金额">
      </el-table-column>
      <el-table-column prop="outDivisionAccount" header-align="center" align="center" label="出账门店所分金额">
      </el-table-column>
      <el-table-column prop="inDivisionAccount" header-align="center" align="center" label="入账门店所分金额">
      </el-table-column>
      <el-table-column prop="ratio" header-align="center" align="center" label="分账比率">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      API.branchaccount.list(params).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(",")}]进行[${id ? "删除" : "批量删除"}]操作?`, "提示", {
        ...
        API.branchaccount.del(ids).then(({ data }) => {
          if (data && data.code === 0) {
            this.$message({
              message: "操作成功",
              type: "success",
