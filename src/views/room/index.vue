<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="roomno" header-align="center" align="center" label="房间编号">
      </el-table-column>
      <el-table-column prop="officeName" header-align="center" align="center" label="所属门店">
      </el-table-column>
      <el-table-column prop="budNums" header-align="center" align="center" label="床位数">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      API.room.list(params).then(({ data }) => {
        if (data && data.code === 0) {
